...
originalResumePath = "../CV_Sagar_Mishra_2025.pdf"
...
username = "sagarmish1234@gmail.com"
password = "trewqZxcbnMpo$uy"
mob = "6290632419"  # Type your mobile number here
...
def UpdateProfile(driver):
    try:
        ...
        WaitTillElementPresent(driver, edit_locator +
                               " | " + saveXpath, "XPATH", 20)
...
def UploadResume(driver, resumePath):
    try:
        ...
        WaitTillElementPresent(driver, CheckPointXpath,
